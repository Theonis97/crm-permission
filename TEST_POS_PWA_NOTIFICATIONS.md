...
curl http://172.20.10.10:3001/api/pwa/debug
...
**Étapes :**
1. Aller sur `http://172.20.10.10:3001/dashboard/stores/[store-id]/pos`
...
curl -X POST http://172.20.10.10:3001/api/store-orders \
...
curl http://172.20.10.10:3001/api/pwa/test
```
