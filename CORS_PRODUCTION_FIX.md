...
## 🎯 Problème identifié
```
Access to fetch at 'https://dev-crm.inotech-gabon.com/api/mobile/auth/me' 
from origin 'https://dev-crm.inotech-gabon.com' has been blocked by CORS policy: 
...
```typescript
{
  ...
  value: process.env.NODE_ENV === "production" 
    ? "https://dev-crm.inotech-gabon.com" 
    : "*",
}
```
...
curl -H "Origin: https://dev-crm.inotech-gabon.com" \
     -H "Access-Control-Request-Method: GET" \
     -H "Access-Control-Request-Headers: Content-Type, Authorization" \
     -X OPTIONS \
     https://dev-crm.inotech-gabon.com/api/mobile/auth/me -v
```
...
```
Access-Control-Allow-Origin: https://dev-crm.inotech-gabon.com
...
**Nginx :**
```nginx
add_header 'Access-Control-Allow-Origin' 'https://dev-crm.inotech-gabon.com' always;
```

**Apache :**
```apache
Header always set Access-Control-Allow-Origin "https://dev-crm.inotech-gabon.com"
```
...
fetch('https://dev-crm.inotech-gabon.com/api/mobile/auth/me', {
  method: 'GET',
