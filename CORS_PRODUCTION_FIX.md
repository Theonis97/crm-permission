...
## 🎯 Problème identifié
```
Access to fetch at 'http://192.168.1.115:3001/api/mobile/auth/me' 
from origin 'http://192.168.1.115:3001' has been blocked by CORS policy: 
...
curl -H "Origin: http://192.168.1.115:3001" \
     -H "Access-Control-Request-Method: GET" \
     -H "Access-Control-Request-Headers: Content-Type, Authorization" \
     -X OPTIONS \
     http://192.168.1.115:3001/api/mobile/auth/me -v
```
...
```
Access-Control-Allow-Origin: http://192.168.1.115:3001
...
**Nginx :**
```nginx
add_header 'Access-Control-Allow-Origin' 'http://192.168.1.115:3001' always;
```

**Apache :**
```apache
Header always set Access-Control-Allow-Origin "http://192.168.1.115:3001"
```
...
fetch('http://192.168.1.115:3001/api/mobile/auth/me', {
  method: 'GET',
