...
import { Plus, Trash2, User, Receipt, Calculator, Settings, AlertTriangle, CheckCircle } from "lucide-react"
...
export function CreateInvoiceSheet({ open, onOpenChange, onInvoiceCreated }: CreateInvoiceSheetProps) {
  ...
  const getClientSectionStatus = () => {
    const hasErrors = errors.title || errors.contactId || errors.dueDate
    const isComplete = title && contactId && dueDate
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Conditions qui apparaîtront sur la facture"
                      rows={3}
                    />
                  </div>
                </div>
