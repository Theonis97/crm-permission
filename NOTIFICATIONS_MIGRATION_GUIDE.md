...
curl -H "Authorization: Bearer <TOKEN>" \
  http://169.254.154.216:3001/api/mobile/notifications
```
...
curl -X POST -H "Authorization: Bearer TOKEN" \
  http://169.254.154.216:3001/api/mobile/notifications/ID/read

# Marquer toutes comme lues
curl -X POST -H "Authorization: Bearer TOKEN" \
  http://169.254.154.216:3001/api/mobile/notifications/read
