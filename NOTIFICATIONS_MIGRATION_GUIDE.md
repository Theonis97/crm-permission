...
curl -H "Authorization: Bearer <TOKEN>" \
  https://inotech-gabon.com/api/mobile/notifications
```
...
curl -X POST -H "Authorization: Bearer TOKEN" \
  https://inotech-gabon.com/api/mobile/notifications/ID/read

# Marquer toutes comme lues
curl -X POST -H "Authorization: Bearer TOKEN" \
  https://inotech-gabon.com/api/mobile/notifications/read
