...
export default function PosPage() {
  ...
  const validateSubBoxOrder = async (orderId: string) => {
    try {
      ...
      console.error("Error validating sub-box order:", error)
  ...
  const cancelSubBoxOrder = async (orderId: string, reason?: string) => {
    try {
      ...
      console.error("Error cancelling sub-box order:", error)
  ...
  const handleCreateClientStoreOrder = async () => {
    ...
    // Si cette vente provenait d'une commande sous-caisse, la valider automatiquement
    if (selectedSubBoxOrder) {
      try {
        await validateSubBoxOrder(selectedSubBoxOrder.id)
      } catch (error) {
        console.error("Erreur lors de la validation automatique de la commande sous-caisse:", error)
        // Ne pas bloquer la vente si la validation échoue
      }
    }
