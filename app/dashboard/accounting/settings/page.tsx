...
export default function AccountingSettingsPage() {
  ...
  const loadConfig = async () => {
    try {
      const response = await fetch("/api/accounting/access/config")
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Paramètres du module Comptabilité</h1>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              Les codes d'accès au module Comptabilité seront envoyés à cette adresse email. 
